<template>
  <div>
    ...
    <p>
      The options object passed into the IntersectionObserver() constructor let
    ...
    <p>
      ...
      values can be percentages. This set of values serves to grow or shrink
      each side of the root element's bounding box before computing
      intersections. Defaults to all zeros.
    </p>
    <h4><code>threshold</code></h4>
    <p>
